...
var file_proto_shippingservice_proto_rawDesc = []byte{
	...
	0x67, 0x49, 0x64, 0x32, 0xb2, 0x01, 0x0a, 0x0f, 0x53, 0x68, 0x69, 0x70, 0x70, 0x69, 0x6e, 0x67,
...
var file_proto_shippingservice_proto_goTypes = []interface{}{
	...
	(*GetQuoteRequest)(nil),   // 3: microshopping.GetQuoteRequest
	(*GetQuoteResponse)(nil),  // 4: microshopping.GetQuoteResponse
	(*ShipOrderRequest)(nil),  // 5: microshopping.ShipOrderRequest
	(*ShipOrderResponse)(nil), // 6: microshopping.ShipOrderResponse
}
var file_proto_shippingservice_proto_depIdxs = []int32{
	2, // 0: microshopping.GetQuoteRequest.address:type_name -> microshopping.Address
	...
	2, // 3: microshopping.ShipOrderRequest.address:type_name -> microshopping.Address
	0, // 4: microshopping.ShipOrderRequest.items:type_name -> microshopping.CartItem
	3, // 5: microshopping.ShippingService.GetQuote:input_type -> microshopping.GetQuoteRequest
	5, // 6: microshopping.ShippingService.ShipOrder:input_type -> microshopping.ShipOrderRequest
	4, // 7: microshopping.ShippingService.GetQuote:output_type -> microshopping.GetQuoteResponse
	6, // 8: microshopping.ShippingService.ShipOrder:output_type -> microshopping.ShipOrderResponse
